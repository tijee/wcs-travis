...
public class HelloActivityTest {
    ...
    public void helloActivityTest() {
        ...
        ViewInteraction appCompatButton = onView(
                allOf(withId(R.id.validateButton), withText("Say hello"),
                        childAtPosition(
                                childAtPosition(
                                        withClassName(is("android.support.constraint.ConstraintLayout")),
                                        0),
        ...
        ViewInteraction textView = onView(
                allOf(withId(R.id.helloTextView), withText("Hello Thomas"),
                        childAtPosition(
                                childAtPosition(
                                ...
                                0),
                        isDisplayed()));
        textView.check(matches(withText("Hello Thomas")));
